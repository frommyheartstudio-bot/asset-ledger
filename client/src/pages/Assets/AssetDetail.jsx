    ...
    return (<AppLayout active="detail" title="Asset Detail" crumb={`Home / Asset Register / ${asset.assetNumber}`}>
      <div className="page-header">
        ...
        <div className="flex gap-2">
          ...
          <PostEventMenu assetNumber={asset.assetNumber} assetStatus={asset.status}/>
      ...
      {tab === 'Transactions' && (<div className="card">
          <div className="card-head">
            ...
            <span className="text-sm text-muted">From ClickHouse · click a row for the full calculation</span>
          </div>
          <AssetTransactionsPanel assetNumber={asset.assetNumber}/>
        </div>)}

      {tab !== 'Overview' && tab !== 'Depreciation Schedule' && tab !== 'Transactions' && (<div className="card card-pad">
