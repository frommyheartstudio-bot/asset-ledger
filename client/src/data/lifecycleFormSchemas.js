...
import { ASSET_CLASS_CODES } from './assetClasses';
...
export const FIELD_SCHEMAS = {
  addition: [
    ...
    { key: 'assetClass', label: 'Asset Class', type: 'select', options: ASSET_CLASS_CODES, hint: 'IRS Pub. 946 asset class code — drives the Dashboard "Assets by Class" breakdown. See Configuration → Asset Classes for what each number covers.' },
