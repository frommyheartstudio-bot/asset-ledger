...
export const users: User[] = [
  { id: 'u1', name: 'Balaji A.', email: 'balaji.a@company.com', role: 'Administrator', lastActive: 'Just now', status: 'Active', password: 'changeme123' },
  { id: 'u2', name: 'Jordan S.', email: 'jordan.s@company.com', role: 'Tax Analyst', lastActive: '2 hours ago', status: 'Active', password: 'changeme123' },
  { id: 'u3', name: 'Maria R.', email: 'maria.r@company.com', role: 'Reviewer', lastActive: 'Yesterday', status: 'Active', password: 'changeme123' },
  { id: 'u4', name: 'Tom P.', email: 'tom.p@company.com', role: 'Read-Only', lastActive: '3 days ago', status: 'Invited', password: 'changeme123' }
];
