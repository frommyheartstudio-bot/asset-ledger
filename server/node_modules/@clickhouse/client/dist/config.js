            ...
            urlSearchParamsKeys.forEach((key) => {
                ...
                switch (key) {
                    case "keep_alive_idle_socket_ttl":
                        ...
                        nodeConfig.keep_alive.idle_socket_ttl = (0, index_1.numberConfigURLValue)({
                            key,
                            value,
                            min: 0,
                        });
