import type { ConnectionParams } from "../common/index";
...
export declare class NodeConnectionFactory {
    static create({ connection_params, tls, keep_alive, http_agent, set_basic_auth_header, capture_enhanced_stack_trace, eagerly_destroy_stale_sockets, max_response_headers_size, }: CreateConnectionParams): NodeBaseConnection;
}
