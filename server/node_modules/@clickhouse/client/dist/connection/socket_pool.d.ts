...
import { ClickHouseLogLevel, type LogWriter, type ConnOperation, type ResponseHeaders, type ClickHouseSummary, type CompressionMethod, type RequestCompression } from "../common/index";
...
export declare class SocketPool {
    ...
    constructor(connectionId: string, params: NodeConnectionParams, createClientRequest: CreateClientRequest, agent: Http.Agent);
